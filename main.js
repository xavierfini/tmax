...
const openBtn - document.querySelector('.header-menu_btn')
const closeBtn - document.querySelector('.menu-close_btn')
const sideBar - document.querySelector('.sidebar')
const sidebarLinks - gsap.utils.toArray('.sidebar_item')
const sidebarLinksBgFill - gsap.utils.toArray('.sidebar_item .link-bg-fill')
const sidebarSocialLinks - gsap.utils.toArray('.header-menu_btn')
...
sidebarLinks.forEach((Link) => {
  link.addEventListener("click", () => {
    ...
    tlOpen.reverse(1.5)
    tlOpen.eventCallbcak("onReverseComplete", redjrectToURL)
  })
})
